...
const MOOD_COMPANION = {
  '想你了':       ['想他的时候，就这样听着吧', '思念的感觉很真实，不用假装没有'],
  '开心开心':     ['今天的你，很好看', '开心的时候最好，把这份快乐留住'],
  '今天很幸福':   ['幸福是真实的，好好感受', '幸福的时候，要好好记住'],
  '需要安慰':     ['一切都会好的，现在先听着', '不需要解释，就这样'],
  '想被抱抱':     ['就当是一个很长的拥抱', '有人在，不孤单'],
  '有点苦恼':     ['有些事想不清楚没关系，先听歌', '今晚先放下，明天再说'],
  '洗澡放松一下': ['今天辛苦了，好好放松', '冲个热水澡，什么都好说'],
  '想一个人发呆': ['就这样漂着，不用去任何地方', '一个人待着也很好，没什么不对'],
  '今天有点累':   ['你已经很努力了，真的', '今天可以早一点休息'],
}
